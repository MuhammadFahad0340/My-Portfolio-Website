...
void main() {
    ...
    // Frame-rate throttle: only render when enough time has elapsed
    ...
    const render = (t: number) => {
      ...
      if (elapsed < frameInterval) return; // skip frame — throttled
      lastFrameTime = t - (elapsed % frameInterval); // stay in sync
